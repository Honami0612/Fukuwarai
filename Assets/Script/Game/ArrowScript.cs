...
public class ArrowScript : MonoBehaviour
{
    ...
    public void OnMouseDrag()
    {
        ...
        arrowPos.position = this.gameObject.transform.localPosition;
        arrowPos.rotation = Quaternion.FromToRotation(Vector3.down, this.currentForce);
        arrowPos.localScale = new Vector3(0.2f, dist, 0.2f);
